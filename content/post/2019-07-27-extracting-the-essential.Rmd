...
"[TextRank](https://cran.r-project.org/web/packages/textrank/vignettes/textrank.html) – is a graph-based ranking model for text processing" . It needs a dataframe with sentences and a dataframe with words which are part of these sentences.
