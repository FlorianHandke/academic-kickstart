---
title: Extracting the essential (with a shiny app)
author: Florian Handke
date: '2019-08-02'
slug: extracting-the-essential-vol-2
categories:
  - shiny
  - textrank
  - Webapp
...
summary: ''
authors: []
lastmod: '2019-08-02T22:34:40+02:00'
featured: no
image:
  caption: ''
  focal_point: ''
...
```{r define ui, message=FALSE, warning=FALSE}
...
```{r load rsconnect, message=FALSE, warning=FALSE}
library(rsconnect)
```
